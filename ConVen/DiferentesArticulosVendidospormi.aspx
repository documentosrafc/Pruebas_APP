<%@ Page Title="Diferentes Articulos Vendidos" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DiferentesArticulosVendidospormi.aspx.cs" Inherits="DiferentesArticulosVendidospormi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <ContentTemplate>
         ...
         <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td> &nbsp;<asp:Label ID="Label1" runat="server" Text="Seleccione la Fecha Inicial" 
                        CssClass="style1" 
                        style="color: #FF9900; font-weight: bold; font-style: italic"></asp:Label> </td>
        ...
        <ServerReport ReportPath="/Reportes_Aplicaciones/Consulta Vendedores/CON_VEN_010_Diferentes Articulos Vendidos por Mi"
