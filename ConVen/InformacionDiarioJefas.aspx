<%@ Page Title="Reporte Diario de Jefas" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="InformacionDiarioJefas.aspx.cs" Inherits="InformacionDiarioJefas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h3>
        Desde esta pantalla podrá colocar las informaciones diarias de su acompañamiento</h3>
    <hr />
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <br />
            <asp:Image ID="Image1" runat="server" ImageUrl="~/1.png" Height="36px" 
                Width="36px" />
            <table border="0" cellpadding="0" cellspacing="0">                             
                <tr>
                <td>
                &nbsp;<asp:Label ID="Label34" runat="server" Text="Acompañamiento? *" Style="color: #FF9900;
                    ...
                    <td>
                        &nbsp;
                        <asp:Label ID="Label15" runat="server" Text="Ruta Efectuada *" Style="color: #FF9900;
                            font-weight: 700; font-style: italic; font-size: small"></asp:Label>
                    </td>
                </tr>
                <tr>
                <td>
                        <asp:DropDownList ID="DropDownList4" runat="server" CssClass="form-control" AutoPostBack = "true" 
                            ToolTip="Debe seleccionar si es un acompañamiento si o no" Width="130px" 
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" AutoPostBack="true"
                            ToolTip="Todos los vendedores que pertenecen a su grupo" Width="211px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td>
                        <asp:TextBox ID="rutaefectuada" runat="server" Width="253px" CssClass="form-control"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        &nbsp;
                        <asp:Label ID="Label2" runat="server" Text="" Style="color: Black; font-weight: 700;
                            font-size: small"></asp:Label>
                    </td>
                </tr>
            </table>
                       <asp:Image ID="Image4" runat="server" ImageUrl="~/4.png" Height="36px" 
                Width="36px" />
            <h4>
                Información de los acompañamientos</h4>
            <hr />
            <div class="row">
                <div class="col-md-5">         
                    <h5>
            ...
            <br />
                       <asp:Image ID="Image2" runat="server" ImageUrl="~/2.png" Height="36px" 
                Width="36px" />
            <h4>
                ...
                <tr>
                    <td colspan="6">
                     ...
                     <%--   <asp:Label ID="Label18" runat="server" Text="" Style="color: Black; font-weight: 700;
                            font-size: small"></asp:Label>--%>
                        <asp:TextBox ID="Label18" runat="server" ReadOnly="true" Width="407px" CssClass="form-control"                                    
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td> 
                                <asp:CheckBox ID="RadioButton5" runat="server" Text="Fuer. Ruta" />
                            </td>
                        </tr>                     
                    </table>
                    <table border="0" cellpadding="0" cellspacing="0">
                ...
                <br />
                <div class="col-md-5">
                           <asp:Image ID="Image3" runat="server" ImageUrl="~/3.png" Height="36px" 
                Width="36px" />
                    <h5>
